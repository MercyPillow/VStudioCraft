...
51. **Halloween Update block set** — Alpha 1.1.0 (Oct 30, 2010), in scope for our 1.1.2_01 target. Pumpkin already shipped (Tier 6 polish). Remaining:
    - **Nether-native mobs / finer terrain / MP sync** (V6+ swim-lane — V1 through V8 shipped).
        ...
        - **V9 (open) — Nether ravines**: terrain-gen extension to `NetherTerrainGenerator`. Long curved carving pass through the netherrack mass, similar to canonical Alpha overworld ravine gen. Adds visual variety to the cavernous space and creates lava cascades when ravines clip a deep lake.
