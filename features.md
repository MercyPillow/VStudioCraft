...
51. **Halloween Update block set** — Alpha 1.1.0 (Oct 30, 2010), in scope for our 1.1.2_01 target. Pumpkin already shipped (Tier 6 polish). Remaining:
    - **Nether-native mobs / finer terrain / MP sync** (V6+ swim-lane — V1 through V9 shipped).
        ...
        - **V10 (open) — Nether fortress structures**: multi-chunk template stamping with path-of-least-resistance fitting (similar shape to the dungeon-gen pass but spanning 4–8 chunks). Adds netherbrick walls / corridors / blaze-spawner rooms. Likely needs a new `NetherBrick` block + spawner-cage extension.
