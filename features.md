...
20. **Snowball (332) + Egg (344) projectiles** — Throwable on RMB, follow ballistic arc. Snowball stacks to 16 and only damages Blazes (which don't exist in Alpha — ours is purely cosmetic). Egg has a small chance to spawn a chick on impact. (The Egg item itself ships with Tier 3 #12's chicken — chicken lays it on a 5..10 min interval — so this entry is just the projectile behaviour.)
